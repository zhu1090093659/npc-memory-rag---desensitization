...
| 服务 | URL |
|------|-----|
| API Service | https://npc-memory-api-xxxxxxxxxxxx.asia-southeast1.run.app |
| Worker Service | https://npc-memory-worker-xxxxxxxxxxxx.asia-southeast1.run.app |
| OpenAPI 文档 | https://npc-memory-api-xxxxxxxxxxxx.asia-southeast1.run.app/docs |
